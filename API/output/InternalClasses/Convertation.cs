...
namespace API.InternalClasses
{
    internal static class Convertation
    {
        ...
        public static string ConvertEnumToString(BookingStatus status)
        {
            return status switch
            {
                BookingStatus.Забронирован => "Забронирован",
                BookingStatus.Оплачен => "Оплачен",
                BookingStatus.Отменен => "Отменен",
                _ => "Неизвестно"
            };
        }
        ...
        public static Enum? ConvertStringToEnum<T>(string value) where T : Enum
        {
            ...
            if (type is BookingStatus)
            {
                return value switch
                {
                    "Забронирован" => BookingStatus.Забронирован,
                    "Оплачен" => BookingStatus.Оплачен,
                    "Отменен" => BookingStatus.Отменен,
                    _ => BookingStatus.Забронирован
                };
            }
